...
function Story({noHeading=false}:{noHeading?:boolean}) {
  return (
    <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4">
      ...
      <AnimatePara text='"More Than Managing Assets—We Build Relationships"' className=" mb-2 xl:-mb-[40px]" />
      </>
}
      <div className="w-[calc(100%-10vw)] h-fit flex flex-col-reverse md:flex-row justify-center items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
        <div className="flex flex-col gap-4 items-start justify-center w-full md:w-[48%] h-fit">
          <div className="flex items-start gap-2 h-fit">
            <img src="/logo2.png" alt="logo" className="w-8 h-8 md:w-10 md:h-10 aspect-square" />
          ...
          <div className="flex items-start gap-2 h-fit">
            <img src="/file.png" alt="logo" className="w-10 h-10 md:w-13 md:h-13 aspect-square" />
            <p className="font-regular text-[12px] sm:text-[14px] md:text-[16px]">
              ...
              <b>highly qualified, optimistic, positive professionals</b> who
              are committed to provide quality service to our clients by
              facilitating their task of achieving their remarkable objectives.
            </p>
          </div>
          <div className="flex items-start gap-2">
            <img src="/tick.png" alt="logo" className="w-10 h-10 md:w-13 md:h-13 aspect-square" />
            <p className="font-regular text-[12px] sm:text-[14px] md:text-[16px]">
              ...
              <b>regulatory, compliance and tax environment in India.</b> We
              provide back-office solutions related to{" "}
              <b>Accounts, Tax and Finance functions.</b>
            </p>
          </div>
        </div>
        <div className="flex items-center justify-center relative w-full md:w-[48%]">
          <img src="/hand.png" alt="hand" className="w-full max-w-[520px] md:max-w-[45vw] relative z-20" />
          <div
            style={{
              position: "absolute",
              width: "40%",
