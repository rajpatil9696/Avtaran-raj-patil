  ...
  return (
    <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
      ...
      <h2 className="text-[24px] leading-[130%] tracking-[-1] mb-[40px] md:-mb-10 md:text-[36px] lg:text-[40px] font-semibold">
        <SplitText text="Corporate Advisory" highlight="Advisory" />
      </h2>
      <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
        <div className="flex -mr-20 flex-col gap-[60px] items-start justify-evenly h-full w-full md:w-[58%]">
          <div className="flex flex-col gap-3">
            <p className="mr-20">
              By offering strategic guidance across governance, compliance,
              restructuring, and financial planning, Corporate Advisory services
              empower organizations to make informed decisions that support
              sustainable growth. These services play a crucial role in helping
              businesses navigate today's complex financial, regulatory, and
              legal landscape.
            </p>
            <p className="mr-20">
              We provide end-to-end support for companies at every stage —
              whether you are expanding, restructuring, entering new markets, or
              strengthening internal controls. We help leaders identify risks,
              uncover opportunities, and align business strategy with long-term
              objectives. With a future-ready approach and deep industry
              expertise, we ensure that your organization remains compliant,
