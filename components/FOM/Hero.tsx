        ...
        <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
            ...
            <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
                <div className="flex -mr-20 flex-col gap-[60px] items-start justify-evenly h-full w-full md:w-[58%]">
                    <p className="mr-20">Our team is a multidisciplinary practice that takes a collaborative approach, and we have the knowledge, resources, and experience needed to offer our customers holistic consulting. Our Family Office Services encompass a broad range of services, such as financial guidance and support, succession planning, regulatory and tax consultation, and business legacy management.</p>
                ...
                <div className="flex items-center justify-center relative right-0 w-full md:w-[48%]">
                    <img src="/fom.png" alt="hand" className="w-full max-w-[520px] md:max-w-[66vw] relative z-20" />
                    <div
                        style={{
                            position: "absolute",
                            width: "40%",
