  ...
  return (
    <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
      ...
      <h2 className="text-[24px] leading-[130%] tracking-[-1] mb-[40px] md:-mb-10 md:text-[36px] lg:text-[40px] font-semibold">
        <SplitText text="Family Office Management" highlight="Management" />
      </h2>
      <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
        <div className="flex -mr-20 flex-col gap-[60px] items-start justify-evenly h-full w-full md:w-[58%]">
          <p className="mr-20">
            Our team brings together a multidisciplinary practice with a modern,
            collaborative approach—equipped with the expertise, technology, and
            industry insights needed to deliver holistic consulting solutions in
            today's fast-evolving business landscape.
          </p>
          <p className="mr-20">
            Through our Family Office Services, we support clients with
            end-to-end advisory, including strategic financial planning,
            succession and estate planning, regulatory and tax compliance, and
            long-term business legacy management. Our goal is to help families
            and enterprises make informed decisions, safeguard their wealth, and
            build a future-ready foundation for the next generation.
          </p>
