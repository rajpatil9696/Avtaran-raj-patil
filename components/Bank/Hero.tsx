  ...
  return (
    <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
      ...
      <h2 className="text-[24px] leading-[130%] tracking-[-1] mb-[40px] md:-mb-10 md:text-[36px] lg:text-[40px] font-semibold">
        <SplitText text="Investment Banking" highlight="Banking" />
      </h2>
      <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
        <div className="flex -mr-20 flex-col gap-[60px] items-start justify-evenly h-full w-full md:w-[58%]">
          <div className="flex flex-col gap-3">
            <p className="mr-20">
              Our Investment Banking practice is built on deep transaction
              experience, sector-specific knowledge, and a strong client-first
              philosophy. We combine strategic insight with hands-on execution
              to help businesses unlock value, raise capital, and navigate
              complex financial decisions with confidence.
            </p>
            <p className="mr-20">
              With expertise across a wide range of investment banking
              solutions—and long-standing relationships with global and domestic
              investors, financial institutions, and market intermediaries—we
              are able to structure innovative, high-impact outcomes for our
              clients.
            </p>
            <p className="mr-20">
              By collaborating seamlessly across geographies, industries, and
              product lines, we deliver integrated advisory, financial
              structuring, and risk management solutions that support
