        ...
        <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
            ...
            <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
                <div className="flex -mr-20 flex-col gap-[60px] items-start justify-evenly h-full w-full md:w-[58%]">
                    <p className="mr-20">In order to provide our clients with the best results possible, our investment banking company combines extensive transaction expertise, in-depth knowledge of numerous industries, and a strong customer-focused approach. Our proficiency in a range of investment banking products and our established connections with investors, market intermediaries, and domestic and foreign corporations enable this. We work together to deliver our clients complete and cutting-edge finance, consulting, and risk solutions by collaborating across countries, industries, and product lines.</p>
                ...
                <div className="flex items-center justify-center relative right-0 w-full md:w-[48%]">
                    <img src="/bank.png" alt="hand" className="w-full max-w-[520px] md:max-w-[66vw] relative z-20" />
                    <div
                        style={{
                            position: "absolute",
                            width: "40%",
