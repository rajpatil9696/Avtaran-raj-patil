      ...
      <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
        <div className="flex -mr-20 flex-col gap-[20px] items-start justify-evenly h-full w-full md:w-[58%]">
          <div className="flex gap-3 flex-col">
            <p className="mr-20">
              Permanent Residency (PR) allows an individual to live in a country
              long-term without becoming a citizen. In simple terms, a permanent
              resident is someone who retains their original nationality but is
              legally authorized by a foreign government to live, work, and
              study in that country indefinitely.
            </p>
            <p className="mr-20">
              Many individuals pursue PR to access better career opportunities,
              advanced education, global mobility, and an improved quality of
              life. Holding a permanent residency visa offers the stability of
              living abroad with full legal rights — without the requirement to
              surrender your home-country citizenship.
            </p>
            <p className="mr-20">
              Our Citizenship and PR Advisory Services help clients understand
              eligibility criteria, documentation requirements, regulatory
              processes, and long-term implications before making this important
              transition. We guide you through every step to ensure clarity,
              compliance, and a smooth pathway toward building a secure future
              abroad.
            </p>
          </div>
