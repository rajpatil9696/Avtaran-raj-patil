        ...
        <section className="w-full min-h-[70vh] h-fit py-[4vh] text-center flex flex-col gap-1.5 relative px-4mb-5 ">
            ...
            <div className="w-full h-fit flex flex-col-reverse md:flex-row justify-start relative items-center gap-6 md:gap-3 px-[1vw] sm:px-[4vw] md:px-[5vw] text-start mx-auto">
                <div className="flex -mr-20 flex-col gap-[20px] items-start justify-evenly h-full w-full md:w-[58%]">
                    <p className="mr-20">The achievement of company objectives and the best possible utilization of resources depend on strategic planning. The procedure is difficult since it requires identifying options and alternatives to deal with company difficulties. Every organization needs business consulting services since they assist in identifying possible problems and the strategies to resolve them quickly. A business's strengths and weaknesses are emphasized in the advice, which also offers insight into potential possibilities and dangers the company may face. To assist our clients in accomplishing their goals, reducing risk, and enhancing their company performance, we offer a wide range of consulting</p>
                ...
                <div className="flex items-center justify-center relative right-0 w-full md:w-[48%]">
                    <img src="/setUp.png" alt="hand" className="w-full max-w-[520px] md:max-w-[66vw] relative z-20" />
                    <div
                        style={{
                            position: "absolute",
                            width: "40%",
