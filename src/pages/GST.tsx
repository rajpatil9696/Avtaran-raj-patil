...
import { GSTCard } from "../../components/GST/helper/constant"
            ...
            <section className="max-w-[1400px] mx-auto px-[2vw] mb-[10vh] flex flex-col justify-center items-center">
                {GSTCard.map((card) => (
                    <NumberCard
                        ...
                        para={[card.para1, card.para2].filter(Boolean) as string[]}
                        ulLIst={[card.ul1, card.ul2, card.ul3].filter(Boolean) as string[]}
                    />
                ))}
            </section>
            <Work />
